            ...
            <div class="ft-content">
                <div class="footer-column">
                    <div class="footer-column-section">
                        <div class="underline">
                            <span class="lbl-large-bold">NEWSLETTER</span>
                        </div>                    
                ...
                <div class="footer-column ft-column-mid">
                    <div class="footer-column-section">
                        <div class="underline">
                            <span class="lbl-large-bold">NAVIGATION+</span>
                        </div>
                        <div class="foot-nav">
                            <ul>
                ...
                <div class="footer-column ft-column-right">
                    <div class="footer-column-section">
                        <div class="underline">
                            <span class="lbl-large-bold">CONNECT</span>
                        </div>

                        <label class="lbl-small ft-get-social">GET SOCIAL</label>
